...
var ButtonBlock = React.createClass({displayName: "ButtonBlock",
    ...
    render: function () {
      ...
      return (
          React.createElement("div", null, 
            React.createElement("button", {className: "btn btn-block {buttonClass}", onClick: buttonHandler}, " ", buttonText)
          )
      );
    }
});
      ...
      React.createElement("div", {className: "well clearfix"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-sm-3"}, 
            React.createElement("img", {className: "panel-media", src: this.props.movie.Poster, alt: this.props.movie.Title})
          ), 
    			React.createElement("div", {className: "col-sm-6"}, 
    				React.createElement("h1", null, this.props.movie.Title)
    			), 
          React.createElement("div", {className: "col-sm-3"}, 
            React.createElement(ButtonBlock, {type: this.props.context, movie: this.props.movie, onChange: this.handleChange})
          )
    		)
      )
    );
...
module.exports = Card;
},{"./ButtonBlock":200,"react":199}],202:[function(require,module,exports){
var React = require('react');
var CardList = require('./CardList');

var CardLayout = React.createClass({displayName: "CardLayout",
  handleChange: function(response) {
      this.props.onChange(response);
  },
  render: function() {
    return(
        React.createElement(CardList, {movies: this.props.movies, onChange: this.handleChange, context: this.props.context})
    );
  }
});
...
},{"./CardList":203,"react":199}],203:[function(require,module,exports){
var React = require('react');
...
var CardList = React.createClass({displayName: "CardList",
  ...
  render: function () {
    ...
    var    publish = movies.map(function (movie) {
          console.log(movie);
          return (
            React.createElement(Card, {movie: movie, onChange: handler, context: context})
          );
        })
...
},{"./Card":201,"react":199}],204:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
      return(
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement(CardLayout, {movies: this.state.movies, context: "favorites", onChange: this.handleChange})
        )
      );
    }
});
...
},{"./CardLayout":202,"./Nav":205,"react":199}],205:[function(require,module,exports){
var React = require('react');
...
var Nav = React.createClass({displayName: "Nav",
  render: function () {
    return(
      React.createElement("div", {className: "navbar navbar-fixed-top clearfix"}, 
      	React.createElement("div", {className: "container clearfix"}, 
      		...
      		React.createElement("a", {className: "navbar-brand brand", href: "/"}, React.createElement("img", {src: "images/brand.png", alt: "My Movies"})), 

      		React.createElement("div", {className: "nav-collapse collapse navbar-responsive-collapse"}, 
      			React.createElement("ul", {className: "nav navbar-nav"}, 
      				React.createElement("li", null, React.createElement(Link, {to: "/"}, "Favourites")), 
              React.createElement("li", null, React.createElement(Link, {to: "/add"}, "Add a movie"))
      			)
      		)
      	)
      )
...
module.exports = Nav;
},{"react":199,"react-router":35}],206:[function(require,module,exports){
var React = require('react');
var Nav = require('./Nav');
...
},{"./Nav":205,"react":199}],207:[function(require,module,exports){
var React = require('react');
      ...
      return(
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement("div", {className: "container"}, 
            ...
            React.createElement(CardLayout, {movies: this.state.movies, context: "results", onChange: this.handleChange})
          )
        )
      );
    }
...
},{"./CardLayout":202,"./Nav":205,"./SearchBar":208,"react":199}],208:[function(require,module,exports){
var React = require('react');
...
var SearchBar = React.createClass({displayName: "SearchBar",
  ...
  handleChanges: function(e) {
    ...
    render: function() {
    return(
      React.createElement("form", {onSubmit: this.handleChanges}, 
        React.createElement("label", {htmlFor: this.props.criteria, className: "labels"}, 
            this.props.criteria
          ), 
        React.createElement("input", {
          ...
          React.createElement("input", {className: "btn btn-lg", type: "submit", value: "GO"})
      )
    );
  }
...
},{"./routes.js":212,"react":199,"react-dom":10,"react-router":35}],210:[function(require,module,exports){
var React = require('react');
...
},{"../components/PageLayout":206,"react":199}],211:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
},{"react":199,"react-router":35}],212:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
React.createElement(Route, null, 
      React.createElement(Route, {handler: MovieApp, name: "MovieApp", path: "/"}), 
      React.createElement(Route, {handler: SearchApp, name: "SearchApp", path: "/add"})
)
);
},{"./components/MovieApp":204,"./components/SearchApp":207,"./pages/HomePage":210,"./pages/Master":211,"react":199,"react-router":35}]},{},[209]);
